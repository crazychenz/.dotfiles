...
require("lazy").setup({
...

	{
		...
		config = function()
			vim.cmd([[
				highlight VirtColumnCustom guifg=#17005c guibg=NONE
			]])

			require("virt-column").setup({
				virtcolumn = "80,120",
				highlight = "VirtColumnCustom",
			})
		end,
	},
	...
	-- scope.nvim saves folder associated state, aka a project config saver
	--{
	--	"tiagovla/scope.nvim",
	--	config = function()
	--		require("scope").setup()
	...
	-- bufdelete is a more pure buffer delete that has minimal side effects.
	-- :bd is the native call and can inadvertantly close the editor, use BDelete instead.
	-- Note: This plugin has the additional effect of not closing the editor
	--       when the _final_ tab is closed, even if configured to do so by neo-tree.
	{
		"famiu/bufdelete.nvim",
	},
	-- Adds tabs (for buffer visibility).
	{
